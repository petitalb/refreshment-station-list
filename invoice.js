...
function addDemo(row) {
  ...
  if (!row.ChefsDePoste) {
    row.ChefsDePoste = [
      {
        Nom: 'ChefsDePoste[0].Nom',
        Prenom: '.Prenom',
        Poste: '.Poste',
        Telephone: '.Telephone'
      },
      {
        Nom: 'ChefsDePoste[1].Nom',
        Prenom: '.Prenom',
        Poste: '.Poste',
        Telephone: '.Telephone'
      }
  ...
  if (!row.Nourriture) {
    row.Nourriture = [
      {
        Nom: 'Nourriture[0].Nom',
        Quantite: '.Quantite',
        Conditionnement: '.Conditionnement',
        Commentaire: '.Commentaire',
      },
      {
        Nom: 'Nourriture[1].Nom',
        Quantite: '.Quantite',
        Conditionnement: '.Conditionnement',
        Commentaire: '.Commentaire',
      },
      {
        Nom: 'Nourriture[2].Nom',
        Quantite: '.Quantite',
        Conditionnement: '.Conditionnement',
        Commentaire: '.Commentaire',
      },
...
function updateInvoice(row) {
  try {
    ...
    const importance = ['Ravitaillement', 'ChefsDePoste', 'Nourriture', 'Course', 'Issued', 'Note'];
